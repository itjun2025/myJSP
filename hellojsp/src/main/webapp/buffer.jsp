<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" errorPage="errerPage.jsp"%>
<%@ page buffer="10kb" autoFlush="true"%>
<!--  버퍼의 크기를 충분히 크게 지정 하던가
		autoFlush속성을 true 로 설정하면 해결 -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
버퍼
	...
	크기를 줄일경우 jsp 의 기능을 온전히 사용하지 못하므로 값을 변경하는 경우거의 없음
 
 버퍼를 사용하는 이유
 	- 성능 향상
 	- JSP 실행 도중 버퍼를 비우고 새로운 내용을 전송 가능
 	- 버퍼가 다 차기전에, 응답 헤더를 변경 가능
 	
 autoFlush
 	true	: 버퍼가 차면, 자동 전송
 	flase	: 버퍼가 차면, 예외 Exception 발생으로 실행 중지
