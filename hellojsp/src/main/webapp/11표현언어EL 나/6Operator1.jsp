...
%>
	...
	<!-- 3.0 부터 대입연산자(=)를 이용하여 값을 대입할 수 있다 -->
	<!-- 값을 대입후 출력 -->
	<p>변수 할당 및 즉시출력 : ${num1 = 7 }</p>
	
	<!-- 값을 대입하고 출력하지 않음 -->
	<p>변수 할당및 별도 출력 : ${num2=8;'' } => ${num2 }</p>
	<p>저장된 변수의 연산 : ${num2 + 7 }</p>
	...
	<h3>산술연산자</h3>
		...
		num1*num2 = ${num1 * num2}<br>
		num1/num2 = ${num1 / num2}<br>
		<!-- 표현언어(EL)을 이용하면 산술연산시 자동으로 숮자로 변환 -->
		<!-- div : 나누기(문자 형태의 연산자) -->
		num3 div num4 : ${num3 div num4 }<br>
		<!-- mod : 나머지(문자 형태의 연산자) -->
		num3 % num 4 : ${num3 % num4}<br>
	...
	<!--  문자형태의 연산자를 사용하여 코드를 좀더 직관적으로 작성할 수 있다 -->
