...
<%
	...
	//saveDirectory="C:\\Users\\user\\git\\myJSP\\hellojsp\\src\\main\\webapp\\upload";
	...
	try{// 1. MultipartRequest객체 생성
		// 생성자의 매개변수로 저장경로, 파일의 최대크기 , 인코딩방식을 지정
		// 객체가 정상적으로
		MultipartRequest mr = new MultipartRequest(request,saveDirectory,maxPostSize,encoding);
		
		// 2. 새로운 파일명 생성
		// 동일한 파일명이 업로드 되는 경우, 기존파일이 소실될 위험이 있으므로 파일명을 변경합니다ㅣ
		...
		JSFunction.alertBack("파일 업로드 오류!!!", out);
		// 이전 페이지로 이동
